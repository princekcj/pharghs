...
class MyPriscriptionOrder extends StatefulWidget {
  const MyPriscriptionOrder({super.key});
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text(
                                    "${"Order ID:".tr} #${preScriptionControllre.priscriptionInfo?.pOrderHistory[index].id ?? ""}",
                                    style: TextStyle(
                                      fontFamily: FontFamily.gilroyBold,
                                      color: BlackColor,
                                      fontSize: 16,
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ticketbutton(
                            ...
                            titleColor: Colors.white,
                            ontap: () {
                              preScriptionControllre.preOrderCancle(
                                oID: orderId,
