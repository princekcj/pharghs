...
import 'package:pharmafast/screen/language/language_screen.dart';
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    alignment: Alignment.center,
                                    child:
                                        Image.asset(model().profileImg[index]),
                                  ),
                                  Expanded(
                                    child: Text(
