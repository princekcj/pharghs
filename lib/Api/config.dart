class Config {
  ...
  static const String orderPriscription = "u_order_prescription.php";
  static const String priscriptionHistory = "u_prescription_history.php";
  static const String priscriptionInformetion = "prescription_information.php";
  static const String preOrderCancle = "pre_cancle.php";
  static const String makeDecision = "make_decision.php";
  static const String priscriptionComplete = "u_prescription_complete.php";
